...
try:
    ...
    cursor.execute("""  CREATE TABLE IF NOT EXISTS permanencia  (int_id integer not null primary key autoincrement, admin varchar(5000),doador varchar(500), id_doador varchar(500), dias varchar(500), data_inicial varchar(500),  data_final varchar(5000),data_aviso varchar(5000));  """)
