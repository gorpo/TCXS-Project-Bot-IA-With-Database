...
async def tcxs(msg):
    if msg.get('text'):
        ...
        if msg['text'] == 'codigo de erro' or msg['text'] == 'erros'  or msg['text'] == 'lista de erros' or msg['text'] == 'erro psn' or msg['text'] == 'erro' or msg['text'] == 'ta dando erro' or msg['text'] == 'deu erro' or msg['text'] == 'meu videogame ta com problema':
            print('Usuario {} solicitou tcxs'.format(msg['from']['first_name']))
            log = '\nUsuario {} solicitou tcxs --> Grupo: {} --> Data/hora:{}'.format(msg['from']['first_name'],msg['chat']['title'],time.ctime())
            arquivo = open('logs/grupos.txt','a')
            arquivo.write(log)
        ...
        if msg['text'] == 'rap' or msg['text'] == 'raps' or msg['text'] == 'licença' or msg['text'] == '14.000' or msg['text'] == 'assinatura':
