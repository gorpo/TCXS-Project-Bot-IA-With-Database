...
async def tcxs(msg):
    ...
    if msg.get('text') and msg['chat']['type'] == 'supergroup' :
        try:
            ...
            if msg['text'] == 'luppy solta a att' and  msg['chat']['title'] == 'Doadores TCXS 2020' or  msg['text'] == 'luppy solta a att' and msg['chat']['title'] == 'manicomio testes' or msg['text'] == 'luppy solta a att' and msg['chat']['title'] == 'L 1 X E 1 R A 😷':
        ...
        if msg['text'] == 'rap' or msg['text'] == 'raps' or 'licença' in msg['text']  or msg['text'] == '14.000' or msg['text'] == 'assinatura':
