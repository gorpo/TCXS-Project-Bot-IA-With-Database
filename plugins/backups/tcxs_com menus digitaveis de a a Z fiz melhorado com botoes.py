...
async def tcxs(msg):
    if msg.get('text'):
        ...
        if msg['text'] == 'licenças':
            await bot.sendMessage(msg['chat']['id'], '`Salve bro, voce esta com problemas mas licenças? caso sim eu vou salvar sua vida, a algum tempo nosso antigo uploader e admin Mello Gamer disponibilizou em seu canal um super tutorial e pratico para que voce tenha todas as licencas, confere la:` https://www.youtube.com/watch?v=4Etx1_5y5tE ','markdown',reply_to_message_id=msg['message_id'])
        if msg['text'] == 'desbloqueio' or msg['text'] == 'o meu ps3' or msg['text'] == 'desbloquear o ps3' or msg['text'] == 'desbloquear meu videogame' or msg['text'] == 'desbloquear o meu ps3' or msg['text'] == 'desbloquear o playstation' or msg['text'] == 'desbloquear o meu console' or msg['text'] == 'desbloqueei meu videogame' or msg['text'] == 'desbloqueei meu console':
            await bot.sendMessage(msg['chat']['id'], '`Tem certeza que ele foi feito de forma correta? O Joao PSX alem de fornecer arquivos bugados e ate mesmo mostrar bugs de mais ao vivo acaba nao fornecendo um material confiavel bem como ele nao tem total dominio doque faz como podemos ver nos videos a quantidade de erros ( ele podia editar os videos), enfim aconselho que veja, reveja e se possivel faça o exploit em cima deste tutorial:` https://www.youtube.com/watch?v=XUUieW4bv_Y','markdown',reply_to_message_id=msg['message_id'])
        if msg['text'] == 'mercado pago':
            await bot.sendMessage(msg['chat']['id'],  'Olá que bom que você quer doar, aqui esta o link de pagamento  ----->   https://www.mercadopago.com.br/checkout/v1/redirect?pref_id=354396246-315fce8c-d8f9-4aa0-8583-95d678936375',reply_to_message_id=msg['message_id'])
        if msg['text'] == 'tutorial' or msg['text'] == 'download segundo plano' or msg['text'] == 'downloads em segundo plano' or msg['text'] == 'Tutorial' or msg['text'] == 'Download em segundo plano' or msg['text'] == 'Downloads em segundo plano'or msg['text'] == 'download em segundo plano':
            await bot.sendMessage(msg['chat']['id'], 'O nosso admin @MsT3Dz  criou um tutorial exclusivo de como fazer os downloads na TCXS Project, bem como os downloads em segundo plano. Confira o tutorial completo: https://youtu.be/_21a5REKhBc',reply_to_message_id=msg['message_id'])
        if msg['text'] == 'tutorial' or msg['text'] == 'instalar' or msg['text'] == 'instalar a loja' or msg['text'] == 'instalar  loja' or msg['text'] == 'como instalar a loja' or msg['text'] == 'Como instalar a loja' or msg['text'] == 'Como instalo a loja'or msg['text'] == 'Instalação' or msg['text'] == 'Tutorial de instalação' or msg['text'] == 'Instalação da tcxs' or msg['text'] == 'instalar a tcxs' or msg['text'] == 'Instalação':
            await bot.sendMessage(msg['chat']['id'], 'O nosso admin @MsT3Dz  criou um tutorial exclusivo de como instalar a loja: https://www.youtube.com/watch?v=aG1jLj8QuBY',reply_to_message_id=msg['message_id'])
...
Basta clicar no botão que te trarei a lista com link direto para download, pedimos sua contribuição para que este projeto se mantenha vivo, Obrigado a todos da TCXS Project!''')
...
#----------------------------------------------------------------------------
        ...
        if msg['text'] == 'lista de jogos' or msg['text'] == 'Lista de jogos' or msg['text'] == 'PSN Stuff' or msg['text'] == 'psn stuff' or msg['text'] == 'psn' or msg['text'] == 'download de jogos' or msg['text'] == 'onde acho jogos para download':
            await bot.sendMessage(msg['chat']['id'], ''' **• Manicomio Bot PSN Stuff By Gorpo Orko TCXS Project!**
                ``` Olá sou um bot que tem toda a lista para download da PSN Stuff com link direto, minha lista esta catalogada por CODIGOS, ou seja você deverá digitar estes codigos para cada lista````lista de códigos deve ser digitada igualmente esta abaixo e sem o traço EX: A a B ou B a D.`
-A a B
-B a D
-E a G
-G a K
...
-S a T
-T a Z
```Basta baixar o PKG e instalar em seu console e bom divertimento, lembre-se que estes jogos precisam dos Rap´s```**[+] MAIS FUNÇÕES DO BOT PARA GAMERS[+]**
-codigo de erro [para ver erros]
-licenças       [para pegar as licenças] 
-desbloqueio    [para desbloquear]
-tutorial       [para instalar a loja]
-download segundo plano [tendeu né]
`Todos os comandos listados devem ser digitados sem o traço!`
